...
static const size_t kRSPIndex = 8;
static const size_t kRBPIndex = 9;
...
enum SPU_ERROR
{
    ...
    CANT_GET_IN_PUSH_SPU    = 4,
    POP_INVAL_REG           = 5,
    CANT_POP_IN_POP_SPU     = 6,
    CANT_POP_IN_OUT_SPU     = 7,
    INVAL_COMMAND           = 8,
    CANT_ADD_SPU            = 9,
    CANT_SUB_SPU            = 10,
    CANT_MUL_SPU            = 11,
    ...
    CANT_CTOR_SPU           = 21,
    CANT_DTOR_SPU           = 22,
    CANT_PUSH_CALL_SPU      = 23,
    CANT_POP_CALL_SPU       = 24,
    CANT_PUSH_IN_SQRT_SPU   = 25,
    CANT_POP_IN_SQRT_SPU    = 26,
    CANT_FIND_SQRT_SPU      = 27,
    CANT_POP_IN_SIN_SPU     = 28,
    CANT_PUSH_IN_SIN_SPU    = 29,
    CANT_POP_IN_COS_SPU     = 30,
    CANT_PUSH_IN_COS_SPU    = 31,
    CANT_POP_IN_MEOW_SPU    = 32,
    CANT_POP_IN_BARK_SPU    = 33,
    WITHOUT_HLT             = 34,
    CANT_MORE_SPU           = 35,
    CANT_MOREEQ_SPU         = 36,
    CANT_LESS_SPU           = 37,
