...
Цель проекта заключалась в том, чтобы написать свой язык ассемблера и реализовать программы, которые бы переводили его в бинарный вид, исполняли его и имели возможность дизассемблировать этот вид в исходное представление.
